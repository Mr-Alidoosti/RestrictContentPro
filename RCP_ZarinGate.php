...
Description: درگاه پرداخت <a href="http://www.zarinpal.com/" target="_blank"> زرین گیت </a> برای افزونه Restrict Content Pro | از سری محصولات وب سایت <a href="http://plugate.ir">پلاگیت</a>
		...
		public function ZarinGate_Setting_By_HANNANStd( $rcp_options ) {
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input class="regular-text" id="rcp_settings[zaringate_merchant]" style="width: 300px;"
                               name="rcp_settings[zaringate_merchant]"
                               value="<?php if ( isset( $rcp_options['zaringate_merchant'] ) ) {
							       echo $rcp_options['zaringate_merchant'];
						       } ?>"/>
                    </td>
                </tr>
                <tr valign="top">
                    ...
                    <td>
                        <input class="regular-text" id="rcp_settings[zaringate_query_name]" style="width: 300px;"
                               name="rcp_settings[zaringate_query_name]"
                               value="<?php echo isset( $rcp_options['zaringate_query_name'] ) ? $rcp_options['zaringate_query_name'] : 'ZarinGate'; ?>"/>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input class="regular-text" id="rcp_settings[zaringate_name]" style="width: 300px;"
                               name="rcp_settings[zaringate_name]"
                               value="<?php echo isset( $rcp_options['zaringate_name'] ) ? $rcp_options['zaringate_name'] : __( 'زرین گیت', 'rcp_zaringate' ); ?>"/>
                    </td>
                </tr>
                <tr valign="top">
                    <th>
